...
<head>
    ...
    <title>{{ config('app.name', 'Ferrari') }}</title>
    ...
    <link rel="icon" href="{{ asset("images/FerrariLogo.ico") }}" type="image/x-icon">
</head>
<body>
    <div id="app">
        <nav class="navbar sticky-top navbar-expand-md navbar-light shadow" style="background-color: #ff2800">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('images/FerrariLogo.png') }}" alt="" height="50">
                </a>
