            ...
            <div class="artist-name text-center">
                ...
                @if (Auth::check())
                    @if (Auth::user()->id == $user->id)
                        <button type="button" class="btn btn-dark btn-block rounded-pill mb-5 btn-grad" onclick="window.location.href='{{ route('user.edit_particulars', Auth::user()->id) }}';">Edit Details</button>    
                    @endif
                @endif
